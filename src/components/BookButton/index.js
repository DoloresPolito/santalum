...
const BookButton = ({text, color, hoverB, hoverC}) => {
  ...
  return (
    <motion.button
      ...
      whileHover={{ backgroundColor: hoverB, borderColor: hoverB, color: hoverC }}
    >
      <p>{text}</p>
      {/* <svg
...
<motion.svg
        ...
        viewBox="0 0 16 20"
        fill="none"
        initial={{ fill: color }} // Inicializa con el color base
        whileHover={{ fill: hoverC }} // Cambia el color en hover
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M14.3678 11.024L6.37289 15.6053V18H6.5535C6.61093 17.2971 6.9667 16.6525 7.53081 16.2292L14.5 11L7.53081 5.77082C6.9667 5.34755 6.61093 4.70291 6.5535 4H6.37289V6.39474L14.37 10.9773L0.499514 10.4945L0.499513 11.4499L14.3678 11.024Z"
          fill="currentColor" // Usa currentColor para heredar el color de hover
        ></path>
      </motion.svg>
